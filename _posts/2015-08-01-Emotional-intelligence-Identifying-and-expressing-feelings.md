...
style: "table{border-collapse:collapse}td{padding:0 .5em}tr:nth-child(2n-1)>td{font-size:5em}tr:nth-child(2n)>td{padding-bottom:1.5em}@media(max-width:672px){tr:nth-child(2n-1)>td{font-size:calc((100vw - 5em) / 3) * 5}}"
