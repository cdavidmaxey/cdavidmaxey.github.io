...
<p>You can follow the typical paths from an evaluation to an Individualized Education Program (IEP) in the infographic below from <a rel="nofollow" href="https://www.understood.org/en/school-learning/special-services/ieps/iep-roadmap-how-to-seek-out-special-education-services-for-your-child" target="_blank">Understood.org</a> and titled <i>IEP Roadmap: How to Seek Out Special Education Services for Your Child</i>, and the following table provides descriptions of disability categories of Special Education eligibility adapted from the Oregon Administrative Rules.</p>
<hr>
