...
.flexbook{flex:0 0 50%;margin:.5rem .25rem}
@media(min-width:477px){.flexbook{flex:0 0 calc(100% / 3)}}
@media(min-width:623px){.flexbook{flex:0 0 25%}}
@media(min-width:796px){.flexbook{flex:0 0 calc(100% / 3)}}
@media(min-width:1032px){.flexbook{flex:0 0 25%}}"
...
<div class="flexbooklist">
	<div class="flexbook">
		<amp-img alt="The Transgender Child by Stephanie Brill and Rachel Pepper" width="414" height="624" src="{{site.cache}}/books/The-Transgender-Child-by-Stephanie-Brill-and-Rachel-Pepper.jpg" sizes="8.625rem"></amp-img>
		<div class="merchants">
