...
<div class="float right side">
	<div>
		...
		<p class="credits"><a rel="nofollow" target="_blank" href="http://nationempowered.org/" target="_blank">&copy;&nbsp;NationEmpowered.org</a></p>
	</div>
	<div>
...
TAG is the acronym commonly used in Oregon for talented and gifted students. Students in Oregon are identified as TAG based on multiple criteria, and school districts typically require scores at or above the 97<sup>th</sup> percentile on a nationally standardized test of mental ability, total reading, or total mathematics (see the <a rel="nofollow" target="_blank" href="https://www.oregon.gov/ode/learning-options/TAG/Pages/TAG-FAQ.aspx" target="_blank">Oregon Department of Education FAQs</a> for more information).
