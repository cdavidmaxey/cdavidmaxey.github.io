...
input#plutchik-en:checked~label[for=plutchik-en],input#plutchik-fr:checked~label[for=plutchik-fr],input#plutchik-es:checked~label[for=plutchik-es]{color:#9c27b0}"
